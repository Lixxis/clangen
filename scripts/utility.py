...
def generate_sprite(
    ...
    try:
        ...
        if cat.pelt.name not in ["Tortie", "Calico"]:
            ...
            patches.blit(
                spirit_dict["tortiemask" + cat.pelt.pattern + cat_sprite],
                (0, 0),
        ...
        if cat.pelt.vitiligo:
            new_sprite.blit(
                spirit_dict["white" + cat.pelt.vitiligo + cat_sprite], (0, 0)
            )
        ...
        if cat.pelt.eye_colour2 != None:
            eyes.blit(
                spirit_dict["eyes2" + cat.pelt.eye_colour2 + cat_sprite], (0, 0)
            )
        ...
        if not scars_hidden:
            for scar in cat.pelt.scars:
                if scar in cat.pelt.scars1:
                    new_sprite.blit(
                        spirit_dict["scars" + scar + cat_sprite], (0, 0)
                    )
        ...
        if game.settings["shaders"] and not dead:
            new_sprite.blit(
                spirit_dict["shaders" + cat_sprite],
                (0, 0),
        ...
        if not scars_hidden:
            for scar in cat.pelt.scars:
                if scar in cat.pelt.scars2:
                    new_sprite.blit(
                        spirit_dict["scars" + scar + cat_sprite],
                        (0, 0),
        ...
        if not acc_hidden:
            if cat.pelt.accessory in cat.pelt.plant_accessories:
                new_sprite.blit(
                    spirit_dict["acc_herbs" + cat.pelt.accessory + cat_sprite],
                    (0, 0),
                )
            elif cat.pelt.accessory in cat.pelt.wild_accessories:
                new_sprite.blit(
                    spirit_dict["acc_wild" + cat.pelt.accessory + cat_sprite],
                    (0, 0),
                )
            elif cat.pelt.accessory in cat.pelt.collars:
                new_sprite.blit(
                    spirit_dict["collars" + cat.pelt.accessory + cat_sprite], (0, 0)
                )
        ...
        if (
            ...
            new_sprite.blit(
                spirit_dict["fademask" + stage + cat_sprite],
                (0, 0),
                special_flags=pygame.BLEND_RGBA_MULT,
            )
