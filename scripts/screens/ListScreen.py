...
class ListScreen(Screens):
    ...
    def handle_event(self, event):
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            if (
                event.ui_element == self.choose_group_button
                and not self.group_options_visible
            ):
                self.update_view_buttons()
            elif (
                event.ui_element == self.choose_group_button
                and self.group_options_visible
            ):
                self.update_view_buttons()
    ...
    def screen_switches(self):
        ...
        self.show_dead_button = UIImageButton(
            scale(pygame.Rect((512, y_pos), (210, 68))),
            "",
        ...
        self.show_living_button = UIImageButton(
            scale(pygame.Rect((512, y_pos), (210, 68))),
            "",
            object_id="#show_living_button",
            manager=MANAGER,
        ...
        x_pos = 717
        self.choose_group_button = UIImageButton(
            scale(pygame.Rect((x_pos, y_pos), (380, 68))),
            "",
            object_id="#choose_group_button",
            manager=MANAGER,
        )
        y_pos += 64
        self.your_clan_button = UIImageButton(
            scale(pygame.Rect((x_pos, y_pos), (380, 68))),
            "",
        ...
        self.sc_button.hide()
        y_pos += 64
        self.cotc_button = UIImageButton(
            scale(pygame.Rect((x_pos, y_pos), (380, 68))),
            "",
        ...
        self.next_page_button = UIImageButton(
            scale(pygame.Rect((912, 1190), (68, 68))),
            "",
            object_id="#arrow_right_button",
            manager=MANAGER,
        )
        self.previous_page_button = UIImageButton(
            scale(pygame.Rect((620, 1190), (68, 68))),
            "",
        ...
        self.filter_by_exp = UIImageButton(
            scale(pygame.Rect((x_pos, y_pos), (296, 68))),
            "",
            object_id="#filter_by_exp_button",
            manager=MANAGER,
        )
        ...
        self.filter_by_death = UIImageButton(
            scale(pygame.Rect((x_pos, y_pos), (296, 68))),
            "",
            object_id="#filter_by_death_button",
            manager=MANAGER,
        )
        self.filter_by_age = UIImageButton(
            scale(pygame.Rect((x_pos, y_pos), (296, 68))),
            "",
            object_id="#filter_by_age_button",
            manager=MANAGER,
        )
        self.filter_by_age_reverse = UIImageButton(
            scale(pygame.Rect((x_pos, y_pos), (296, 68))),
            "",
            object_id="#filter_by_age_reverse_button",
            manager=MANAGER,
        )
        y_pos += 64
        ...
        self.update_search_cats(
            ""
        )  # This will list all the cats, and create the button objects.
            ...
            for cat in self.chunks(self.current_listed_cats, 20)[self.list_page - 1]:
                ...
                self.cat_names.append(
                    pygame_gui.elements.ui_label.UILabel(
                        scale(pygame.Rect((170 + pos_x, 460 + pos_y), (300, 60))),
                        short_name,
